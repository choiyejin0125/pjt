...
const Contents = () => {
    return(
        <>
        <GameInfos 
        src="..\imgs\gameimgs\game1/game1_img01.jpg"
        name="리미디엄 (REMEDIUM)"

        info_title="으스스하고 포스트 아포칼립스적인 르네상스 세계관 기반의 신속한 트윈 스틱 슈팅 게임입니다. 끔찍한 역병이 온 대륙을 뒤덮고 거의 모든 생명들을 격노한 돌연변이로 탈바꿈시킨지도 수백년이 지났습니다."

        genre="액션, RPG, 어드벤처"
        originator="Sobaka Studio"
        distributor="ESDigital Games"
        language="독일어, 영어, 스페인어, 프랑스어, 이탈리어, 한국어"
        use="청소년이용불가"
        date="2024.07.16"
