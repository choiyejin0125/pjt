...
const Contents = () => {
    return(
        <>
        <GameInfos 
        src="..\imgs\gameimgs\game17/game17_img01.jpg"
        name="카라반 샌드위치 (Caravan Sandwitch)"

        info_title="매혹적인 서사 중심의 탐험 어드벤처, Caravan SandWitch에서 광대한 풍경을 가로지르는 여정을 떠납니다."

        genre="어드벤처"
        originator="Studio Plane Toast"
