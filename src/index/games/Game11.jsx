...
const Contents = () => {
    return(
        <>
        <GameInfos 
        src="..\imgs\gameimgs\game11/game11_img01.jpg"
        name="엘든 블링 (ELDEN BLING)"

        info_title="맛있는 새 대마초를 들이킨 타이론. 하지만 거기에 치사량의 펜타닐이 들어 있었기 때문에 그는 죽고 말았습니다... 고대 파라오의 소유물이자 권능의 상징인 '엘든 블링'을 찾아내 타이론의 운명을 바꿔 보세요..."

        genre="액션"
        originator="Team SNEED"
        distributor="Team SNEED"
        language="영어, 한국어"
        use="청소년이용불가"
        date="2024.07.17"
