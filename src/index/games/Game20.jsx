...
const Contents = () => {
    return(
        <>
        <GameInfos 
        src="..\imgs\gameimgs\game20/game20_img01.jpg"
        name="RPG 메이커 MZ (RPG MAKER MZ)"

        info_title="RPG Maker MZ를 소개합니다. RPG Maker 시리즈의 최신 버전으로 누구나 쉽게 RPG를 만들 수 있습니다! 새로운 기능과 동작 개선을 통해 제작 환경이 향상되고 더욱 강력한 연출 표현이 가능해져 플레이어가 진정으로 추구하는 게임을 제작할 수 있습니다."

        genre="액션, 슈팅, 캐주얼"
        originator="넵튠"
        distributor="넵튠"
        language="한국어, 영어, 중국어(간체)"
        use="12세 이용가"
        date="2024.06.25"
