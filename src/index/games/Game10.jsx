...
const Contents = () => {
    return(
        <>
        <GameInfos 
        src="..\imgs\gameimgs\game10/game10_img01.png"
        name="아이 씨 레드 (I See Red)"

        info_title="매튜 타우러스는 충격적인 사건으로 모든 것을 잃은 후 존경받는 경찰에서 복수심에 불타는 무법자로 변했습니다. 이 격렬한 트윈스틱 슈터 로그라이트에서 적을 찾아서 파괴해야 하는데, 위험한 우주선을 뒤지며 분노를 표출하세요."

        genre="액션, 슈팅"
        originator="Whiteboard Games"
        distributor="Whiteboard Games"
        language="영어, 한국어, 일본어, 프랑스어, 독일어"
        use="청소년이용불가"
        date="2024.07.17"
