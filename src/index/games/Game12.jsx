...
const Contents = () => {
    return(
        <>
        <GameInfos 
        src="..\imgs\gameimgs\game12/game12_img01.jpg"
        name="로터스 랜턴: 보련등 이야기 (Lotus Lantern: Rescue Mother)"

        info_title="천지의 영물 '보련등', 세상을 뒤흔들고 시공을 가르네! 《로터스 랜턴: 보련등 이야기》은 중국 신화를 배경으로 하는 초액션 로그라이트 게임입니다. 플레이어는 주인공 '침향'이 되어 어머니를 구하기 위한 여정에서 다양한 문파를 경험하고 전설 속 수많은 법구를 조합해 운명에 맞서야 합니다!"

        genre="액션"
        originator="Unstable Games"
        distributor="Plaisir Games"
